...
\begin{document}
	...
	\begin{frame}{Branching patterns}
		\begin{itemize}
			\item Best branching pattern: don't \pause
			\item Second best branching pattern: as little as possible, for as short a time as possible \pause
		\end{itemize}
	\end{frame}
