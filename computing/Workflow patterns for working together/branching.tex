...
\begin{document}
	...
	\begin{frame}{Defining continuous integration}
		\begin{itemize}
			\item Every developer commits at least daily to the shared mainline \pause
			\item every commit triggers an automated build and test \pause
			\item if build and test fails, it's repaired within 10 minutes \pause
			
			\rightline{- Martin Fowler, paraphrasing Jez Humble}
		\end{itemize}
	\end{frame}
