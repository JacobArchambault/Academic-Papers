...
\end{abstract}
 %`seventeenth-century occasionalism was almost exclusively a Cartesian phenomenon' Nadler 2005, 37.
%The definition of occasionalism assumed for more than a third of a century, essentially from the beginning of secondary literature on the subject, is mistaken.
...
Occasionalism is best known for its solutions to the problems of individuation and the mind-body relation, according to which both the correspondence of a rational creature's mental volitions with its bodily action and the unity of individual material substances are effected directly by God. In secondary literature on occasionalism today, it is common to distinguish partial, sometimes called local occasionalism, from full-blown or global occasionalism, with the former affirming and the latter denying activity to minds besides bodies. This distinction is first hinted at in Daniel Garber's work on Descartes' account of motion, and first advanced shortly thereafter in Daisie Radner and Steven Nadler's work on occasionalism and on Louis de La Forge in particular \autocite{Garber1987,,Radner1993,Nadler1998}. The distinction has since become widespread, with its canonicity witnessed by its acceptance in the Stanford Encyclopedia of Philosophy's entry on occasionalism.\footnote{\autocite{Clatterbaugh1996}, \autocite{Clarke2000}, \autocite{Bardout2002}, and \autocite{Kolesnik2006}, \autocite{Lee2007}, \autocite{Sangiacomo2014}, \autocite{sep-occasionalism}.}
