...
we can say that Anglophone philosophy of the past seventy or so years as primarily interpreted the question of what there is as one equivalent to that of what \emph{things} there \emph{are}. 
In other words, 
...
This understanding of ontology, however, is an attentuation of a broader notion,
and arguably not the sense in which that part of metaphysics was understood by the ancient and earlier medieval interpreters of Aristotle:
...
take, for instance, the propositions grounding the convertibility of the transcendental predicates with being itself: to be is to be good, to be one, to be distinct, etc.
