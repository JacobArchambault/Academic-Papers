...
is that a semantics containing structures meant to model an understanding of being, 
%such as quantifiers or a domain, 
considered in itself and on its intended interpretation, 
cannot wholly avoid a decision on ontological questions on the matters it directly pertains to or in which it is indirectly implicated. 
%From this standpoint, the use a particular philosopher makes of that semantics is beside the point.
