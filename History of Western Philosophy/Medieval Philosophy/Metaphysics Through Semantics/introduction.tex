...
- a claim which itself relegates claims of meaning to a purely mental sphere via its own question-begging metaphysical post-Kantianism - 
%tacitly assuming as it does an ontological distinction between mental and real spheres that is `crossed' or `bridged' by language - 
and instantiates a post-Ockhamist error that Klima himself identifies, 
viz. that of assuming 
