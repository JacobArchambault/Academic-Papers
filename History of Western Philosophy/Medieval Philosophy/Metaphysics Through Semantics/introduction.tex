...
One simple yet powerful validation of this understanding is that the converse entailment schema intuitively fails: 
...
%What is predicated essentially of a subject differs from what follows necessarily from an essential predication of that subject.
%Consequently, not everything necessarily following 
