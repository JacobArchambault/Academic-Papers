...
Despite this, the two will have no \emph{linguistic} problem communicating with each other, given the presence of a well-known translation schema
Conversely, 
an employer of possibilist semantics may reject the semi-Quinean assumption about quantification above, 
and instead opt for the claim that the primary sense of being is that expressed by the first-order existence predicate, 
in which case the same possibilist semantics is itself used to express the content of actualism in the language of possibilism. 
