...
in which case possibilist semantics itself is used to express the content of actualism.\footnote{
	Indeed, we have a close analogue to this in medieval logic itself, 
	...
	while William of Sherwood and Roger Bacon identify a term's signification with its reference to actual presently existing things. 
