...
first, that as implied above, one's options in metaphysics may be limited by the semantics one inhabits;
...
The first problem generalizes one nearly the opposite of that established by G\"{o}del first incompleteness theorem in \autocite{Godel1931}:
...
as a solution to the impasse \autocite{Klima2000,Klima2009a}.
%Quote Gadamer
