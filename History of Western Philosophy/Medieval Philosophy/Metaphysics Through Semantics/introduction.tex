...
\section{Expressiveness and the meaning of `metaphysics'}
In this way, 
...
we can no longer construe a semantics providing an account of being on its canonical interpretation as ontologically neutral, 
precisely \emph{because} it provides such an account.
...
much as with the Quinean classicists' superficial agreement with the modal actualist, 
there is a respect in which Klima's Notre Dame colleagues were correct in spite of themselves. 
%No truth table account of necessity

Even in contemporary analytic discourse the Quinean program in ontology has exhausted itself.
