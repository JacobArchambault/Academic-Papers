...
Conversely, an employer of possibilist semantics may even reject the semi-Quinean assumption about quantification above, 
and instead opt for the claim that the primary sense of being is that expressed by being in the extension of the first-order existence predicate $E$ at some priviledged world $w$, 
in which case possibilist semantics itself is used to express the content of actualism.\footnote{
	Indeed, we have a close analogue to this in medieval semantics concerning reference, 
...
and the ontological viewpoint encompassed in each of them is closer to that of the other than either is to that of the classical exclusivist who rejects modality altogether, 
