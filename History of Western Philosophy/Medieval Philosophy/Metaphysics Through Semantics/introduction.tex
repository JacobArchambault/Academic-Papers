...
takes an affirmative statement to be true when its subject and predicate term refer to the same object 
 - what is sometimes called the \emph{identity theory of predication}. 
...
but may instead be taken to refer to familiar objects \emph{differently}. 
...
and hence to refer to the same object as that rigidly referred to by the proper name `Socrates', 
