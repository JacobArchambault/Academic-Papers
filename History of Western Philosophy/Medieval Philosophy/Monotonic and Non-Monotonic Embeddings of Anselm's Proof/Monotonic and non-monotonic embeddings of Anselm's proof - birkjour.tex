...
\subjclass{Primary 01A35, 03A05, 03B42; Secondary 01A85, 03B80}
\keywords{Anselm of Canterbury, \textit{Proslogion}, ontological argument, monotonicity, non-monotonic logic}
\maketitle
...
\fitchprf{\pline[1.]{\uni{x}{(Tx \rightarrow Ggx)}}[(Pros. 15)]\\
	\pline[2.]{\neg \exi{x}{(Gxx)}}[]\\
...
\fitchprf{\pline[1.]{(\lambda x. \neg \exists{y}{(Ty \wedge Gyx)} \wedge \neg \exists{y}{(\Theta(Gyx))})(g)}[(Pros. 2)]\\
	\pline[2.]{\uni{x}{(Tx \rightarrow Ggx)}}[(Pros. 15)]\\
	\pline[3.]{\neg \exi{x}{(Gxx)}}[]}{
