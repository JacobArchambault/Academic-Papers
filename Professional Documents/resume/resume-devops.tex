...
\begin{document}
	...
	\begin{scshape}
		\begin{footnotesize}
			\input{resume-devops-subheader}
		\end{footnotesize}
	\end{scshape}
	\vspace*{0.4cm}

\input{contact-info}	
\input{education-shorter.tex}
...
%\input{projects-devops}

%\input{honors.tex}
%\input{publications-logic}
\input{skills-programming}
%\input{references-tech}
\end{document}