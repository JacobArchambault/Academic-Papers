...
\datedsubsectionnarrow{Oct 2021-May 2022}{Support team}{Associate Software Developer}{
	Formulated solutions for critical bugs and data fixes for both customer-facing and internal websites. 
	Improved premium tracking feature performance 26X by Unified multiple API calls and removed Cartesian explosion for premium tracking feature causing slow coverage period loading, leading to a 26X performance improvement. 
